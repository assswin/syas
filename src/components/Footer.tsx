  ...
  return (
    <footer className="bg-[rgba(4,5,7,0.95)] text-slate-400 py-16 font-sans text-left transition-colors relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="flex items-center space-x-2.5 cursor-pointer" onClick={() => handleNavClick('home')}>
              ...
              <span className="font-extrabold text-sm tracking-tight text-white">
                Syay<span className="text-indigo-400">Labs</span>
              </span>
            </div>
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-wrap gap-1.5">
              {["React", "Node.js", "Python", "Vite", "AWS", "MongoDB"].map((tech, idx) => (
                <span 
                  key={idx} 
                  className="bg-slate-800 text-slate-400 text-[9px] font-bold px-2 py-0.5 rounded border border-slate-700/60"
                >
                  {tech}
                </span>
              ))}
            ...
            <div className="pt-4 border-t border-slate-800/80 space-y-1">
              <span className="text-[9px] text-slate-500 block uppercase font-bold">Main Office</span>
              <span className="text-[10px] block leading-normal">{t('contact.info.location')}</span>
            </div>
          </div>
        ...
        <div className="pt-8 flex flex-col sm:flex-row justify-between items-center text-[10px] text-slate-550 space-y-4 sm:space-y-0">
